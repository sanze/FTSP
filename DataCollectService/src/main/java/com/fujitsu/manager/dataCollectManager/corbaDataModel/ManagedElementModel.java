...
public class ManagedElementModel {
	...
	//内部网元名原始值
	private String nativeEMSNameOri;
	...
	public String getNativeEMSNameOri() {
		return nativeEMSNameOri;
	}

	public void setNativeEMSNameOri(String nativeEMSNameOri) {
		this.nativeEMSNameOri = nativeEMSNameOri;
	}
