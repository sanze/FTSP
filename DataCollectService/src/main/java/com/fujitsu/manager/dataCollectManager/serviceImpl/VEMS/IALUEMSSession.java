...
public interface IALUEMSSession extends IEMSSession{
	...
	/** #获取所有getTopologicalLinksOfFDFr数据# */
	public TopologicalLink_T[] getTopologicalLinksOfFDFr(NameAndStringValue_T[] flowDomainName) throws CommonException;
}