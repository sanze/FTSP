...
public class EquipmentHolderModel {
	...
	private String acceptableEquipmentTypeSrting;
	...
	public String getAcceptableEquipmentTypeSrting() {
		return acceptableEquipmentTypeSrting;
	}
	public void setAcceptableEquipmentTypeSrting(
			String acceptableEquipmentTypeSrting) {
		this.acceptableEquipmentTypeSrting = acceptableEquipmentTypeSrting;
	}
}
