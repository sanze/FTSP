...
public class EquipmentModel {
	...
	private boolean isSubUnit = false;
	...
	public void setSubSlotNo(String subSlotNo) {
		...
		this.isSubUnit=(subSlotNo!=null&&!subSlotNo.isEmpty());
	}
	...
	public void setSubUnit(boolean isSubUnit) {
		this.isSubUnit = isSubUnit;
	}
	public boolean isTransparency() {
		return isTransparency;
	}
	public void setTransparency(boolean isTransparency) {
