 ...
 * 
 */
public class DataCollectDefine extends BaseDefine{
	
	public static class DISPLAY_MODE{
		public final static int NATIVE_EMS_NAME=1;
		public final static int USER_LABEL=2;
	...
	// 需要同步
	public final static int SYNC_NEED_FLAG = 4;
	// 正在同步
	public final static int SYNC_ING_FLAG = 5;
	...
	// 显示自动模式
	public final static int DISPLAY_MODE_AUTO = 1;
	// 显示手动模式
	public final static int DISPLAY_MODE_MANUAL = 2;
	
	// CHANGE_TYPE 1.新增、2.删除、3.删除冲突源、4.更新
	public final static int CHANGE_TYPE_ADD = 1;
	public final static int CHANGE_TYPE_DELETE = 2;
	public final static int CHANGE_TYPE_DELETE_CONFLICT = 3;
	public final static int CHANGE_TYPE_UPDATE = 4;
...
//	public final static int NMS_TYPE_VEMS_FLAG = 99;
	...
	//朗讯数据中本身含有","所以更换分隔符，由原来的","->"@"
	public final static String MYSQL_FILE_TERMINAL_SYMBOL = "@"; 
	...
	// 丢弃的告警清除消息记录
	public final static String T_WASTE_ALM_MSG = "T_WASTE_ALM_MSG";
	// 原始告警消息记录
	public final static String T_ALARM_MSG = "T_ALARM_MSG";
	// 告警消息稽核记录
	public final static String ALARM_JMS_AUDIT = "ALARM_JMS_AUDIT";
	...
	// 告警分析状态 使用TRUE FALSE代替
	//public final static int IS_ANALYSIS_YES = 1;
	//public final static int IS_ANALYSIS_NO = 0;
	
	// 废弃的告警清除原始信息保存开关参数
	public final static String WASTE_ALARM_CLEAR_KEY = "WASTE_ALARM_CLEAR";
	// 原始告警消息保存开关参数
	public final static String ALARM_MSG_SAVE_KEY = "ALARM_MSG_SAVE";
	// 性能转换Debug输出开关设置，参数对应数据库中的key
	public final static String PM_DEBUG_PARAM_KEY = "PM_DEBUG";
	...
	public static class COMMON {
		...
		public final static String SUB_SLOT_LUCENT = "sub-slot";
		public final static String UNIT = "unit";
		public final static String SUB_UNIT = "sub_unit";
		public final static String PORT = "port";
		
		public final static String TMP = "tmp";
		public final static String TMPCTP = "tmpctpID";
		...
		public final static String NT_ATTRIBUTE_VALUE_CHANGE = "NT_ATTRIBUTE_VALUE_CHANGE";
		public final static String NT_OBJECT_CREATION = "NT_OBJECT_CREATION";
		// 中兴请求同步通知
		public final static String NT_REQUEST_SYNCHRONIZATION = "NT_REQUEST_SYNCHRONIZATION";
		public final static String NT_OBJECT_DELETION = "NT_OBJECT_DELETION";
		public final static String NT_PROTECTION_SWITCH = "NT_PROTECTION_SWITCH";
		public final static String NT_WDMPROTECTION_SWITCH = "NT_WDMPROTECTION_SWITCH";
		public final static String NT_EPROTECTION_SWITCH = "NT_EPROTECTION_SWITCH";
		public final static String NT_ATMPROTECTION_SWITCH = "NT_ATMPROTECTION_SWITCH";
		public final static String NT_RPRPROTECTION_SWITCH = "NT_RPRPROTECTION_SWITCH";
		...
		// pmLocation描述
		public static final String PM_LOCATION_NEAR_END_RX = "PML_NEAR_END_Rx";
		public static final String PM_LOCATION_FAR_END_RX = "PML_FAR_END_Rx";
		public static final String PM_LOCATION_NEAR_END_TX = "PML_NEAR_END_Tx";
		public static final String PM_LOCATION_FAR_END_TX= "PML_FAR_END_Tx";
		public static final String PM_LOCATION_NA = "PML_BIDIRECTIONAL";
				
		public static HashMap<Integer, String> LOCATION = new HashMap<Integer, String>();
		static{
			LOCATION.put(COMMON.PM_LOCATION_NEAR_END_RX_FLAG , PM_LOCATION_NEAR_END_RX);
			LOCATION.put(COMMON.PM_LOCATION_FAR_END_RX_FLAG , PM_LOCATION_FAR_END_RX);
			LOCATION.put(COMMON.PM_LOCATION_NEAR_END_TX_FLAG , PM_LOCATION_NEAR_END_TX);
			LOCATION.put(COMMON.PM_LOCATION_FAR_END_TX_FLAG , PM_LOCATION_FAR_END_TX);
			LOCATION.put(COMMON.PM_LOCATION_NA_FLAG , PM_LOCATION_NA);
		}
	...
	public static class HW {
		...
		// 告警数据数组索引定义
		public static final short ALARM_NOTIFICATION_ID = 0;
		public static final short ALARM_OBJECT_NAME = 1;
		public static final short ALARM_NATIVE_EMS_NAME = 2;
		public static final short ALARM_NATIVE_PROBABLE_CAUSE = 3;
		public static final short ALARM_OBJECT_TYPE = 4;
		public static final short ALARM_EMS_TIME = 5;
		public static final short ALARM_NE_TIME = 6;
		public static final short ALARM_IS_CLEARABLE = 7;
		public static final short ALARM_LAYER_RATE = 8;
		public static final short ALARM_PROBABLE_CAUSE = 9;
		public static final short ALARM_PROBABLE_CAUSE_QUALIFIER = 10;
		public static final short ALARM_PERCEIVED_SEVERITY = 11;
		public static final short ALARM_SERVICE_AFFECTING = 12;
		public static final short ALARM_AFFECTED_TPLIST = 13;
		public static final short ALARM_ADDITIONAL_TEXT = 14;
		public static final short ALARM_ADDITIONAL_INFO = 15;
		public static final short ALARM_X733_EVENTTYPE = 16;
		public static final short ALARM_OBJECT_TYPE_QUALIFIER = 17;
		public static final short ALARM_RCAIINDICATOR = 18;					// 仅U2000
		public static final short ALARM_X733_CORRELATED_NOTIFICATIONS = 19;   // 仅U2000
	...
	public static class ZTE {
		...
		public final static String ZTE_CTP_RS256 = "rs256";
		public final static String ZTE_CTP_RS64 = "rs64";
		public final static String ZTE_CTP_RS16= "rs16";
		public final static String ZTE_CTP_RS4 = "rs4";
		public final static String ZTE_CTP_RS1 = "rs1";
		public final static String ZTE_CTP_10GE = "10ge";
		public final static String ZTE_CTP_GE = "ge";
		...
		// zte pmLocation描述
		/**
		09.第三方资料\ZTE\IDL_中兴提供_ZXONM_NML-EML_CORBA接口规范.pdf 238页
		20. PMLocation_T
		定义
		typedef string PMLocation_T;
		说明
		性能检测位置。取值为：“Bidirectional”、“Near_End”、“Far_End”。*/
		public static final String ZTE_PM_LOCATION_NEAR_END_RX = "Near_End";
		public static final String ZTE_PM_LOCATION_FAR_END_RX= "Far_End";
		public static final String ZTE_PM_LOCATION_NEAR_END_TX = "Near_End";
		public static final String ZTE_PM_LOCATION_FAR_END_TX= "Far_End";
		public static final String ZTE_PM_LOCATION_NA  = "Bidirectional";
		...
		// 告警数据数组索引定义
		// E300
		public static final short ALARM_E300_OBJECT_NAME = 0;
		public static final short ALARM_E300_ALARM_DETECT_INFO = 1;
		public static final short ALARM_E300_PROBABLE_CAUSE = 2;
		public static final short ALARM_E300_ALARM_TYPE = 3;
		public static final short ALARM_E300_PERCEIVED_SEVERITY = 4;
		public static final short ALARM_E300_RAISE_TIME = 5;
		public static final short ALARM_E300_CLEAR_TIME = 6;
		public static final short ALARM_E300_ADDITIONAL_INFO = 7;
		public static final short ALARM_E300_LAYER_RATE = 8;
		public static final short ALARM_E300_OBJECT_TYPE = 9;
		public static final short ALARM_E300_OBJECT_FILTER_NAME = 10;
		// U31
		public static final short ALARM_U31_NOTIFICATION_ID = 0;
		public static final short ALARM_U31_OBJECT_NAME = 1;
		public static final short ALARM_U31_OBJECT_FILTER_NAME = 2;
		public static final short ALARM_U31_ALARM_DETECT_INFO = 3;
		public static final short ALARM_U31_PROBABLE_CAUSE = 4;
		public static final short ALARM_U31_ALARM_TYPE = 5;
		public static final short ALARM_U31_PERCEIVED_SEVERITY = 6;
		public static final short ALARM_U31_RAISE_TIME = 7;
		public static final short ALARM_U31_CLEAR_TIME = 8;
		public static final short ALARM_U31_ADDITIONAL_INFO = 9;
		public static final short ALARM_U31_LAYER_RATE = 10;
		public static final short ALARM_U31_OBJECT_TYPE =11;
		public static final short ALARM_U31_EMS_TIME = 12;
		public static final short ALARM_U31_CORRELATED_ALARM_IDS = 13;
		public static final short ALARM_U31_DESCRIPTION = 14;
		public static final short ALARM_U31_SERVICE_AFFECTING = 15;
		public static final short ALARM_U31_CONFIRM_STATUS = 16;
		public static final short ALARM_U31_CLEAR_STATUS = 17;
		public static final short ALARM_U31_IS_CLEARABLE = 18;
		public static final short ALARM_U31_ACK_USER = 19;
		public static final short ALARM_U31_ACK_TIME = 20;
		public static final short ALARM_U31_ACK_INFO = 21;
		public static final short ALARM_U31_VENDOR_PROBABLE_CAUSE = 22;
		public static final short ALARM_U31_ALARM_STATUS =23;
		public static final short ALARM_U31_CUSTOMER_NAME = 24;
		public static final short ALARM_U31_DIAGNOSE_INFO = 25;
	...
	public static class ALU {
		...
		public static final String GRANULARITY_24HOUR_STRING = "24 hours";
//		public static final String GRANULARITY_15MIN_STRING = "15 minutes";
		
		public final static String SUB_SLOT = "sub-slot";
		public final class HolderType{
			public final static String SUB_SLOT = "unknow";
		}
		
		public final static String PTP_RACK = "r";
		public final static String PTP_SHELF = "((sr)|s|-)";
		public final static String PTP_SLOT = "((sl)|b|-)";
		public final static String PTP_PORT = "(p|/(port#)?)";
		
		public final static String PTP_REGEX = PTP_RACK+"[0-9]+"+PTP_SHELF+"[0-9]+"+PTP_SLOT+"[0-9]+"+PTP_PORT+"[^-]*";
		public final static String SUB_PTP_REGEX = "/port=.*#[0-9]+#[0-9]+.*$";
		public final static String HOLDER_REGEX = "^[0-9]+((-[0-9]+)+)?$";
		
		// FIXME 以下定义需要核实
		public final static String ALU_CTP_OS = "os";
		public final static String ALU_CTP_OTS = "ots";
		public final static String ALU_CTP_OMS = "oms";
		public final static String ALU_CTP_OCH = "och";
		public final static String ALU_CTP_ODU0 = "odu0";
		public final static String ALU_CTP_ODU1 = "odu1";
		public final static String ALU_CTP_ODU2 = "odu2";
		public final static String ALU_CTP_ODU3 = "odu3";
		public final static String ALU_CTP_OTU0 = "otu0";
		public final static String ALU_CTP_OTU1 = "otu1";
		public final static String ALU_CTP_OTU2 = "otu2";
		public final static String ALU_CTP_OTU3 = "otu3";
		public final static String ALU_CTP_DSR = "dsr";
	}
