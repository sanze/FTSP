...
public class StartUp{
	...
	public static void init() throws CommonException{
		...
		IAlarmConvergeService alarmConvergeService = (IAlarmConvergeService) BeanUtil
				.getBean("alarmConvergeService");
		// 告警收敛服务初始化
		alarmConvergeService.init();
	}
