...
<html>
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/ux/BufferView.js"></script>
   ...
   <%--  <script type="text/javascript">
    ...
    <script type="text/javascript" src="highQueryDetailHistory.js"></script>
    <style type="text/css">
		.alarm-color1{
			background: #FF0000;
		}	
