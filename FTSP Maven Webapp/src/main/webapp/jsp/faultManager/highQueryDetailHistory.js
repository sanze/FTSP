...
var store = new Ext.data.Store({
	...
	reader : new Ext.data.JsonReader({
			...
			['_id','OBJECT_TYPE','PTP_ID','NE_ID','UNIT_ID','BASE_LINK_ID','BASE_PRO_GROUP_ID',
			 'PERCEIVED_SEVERITY','NATIVE_PROBABLE_CAUSE','NORMAL_CAUSE','EMS_GROUP_NAME','EMS_NAME','NE_NAME','PRODUCT_NAME',
			 'SLOT_DISPLAY_NAME','UNIT_NAME','PORT_NAME','DOMAIN','PTP_TYPE','INTERFACE_RATE','CTP_NAME','FIRST_TIME','AMOUNT',
			 'NE_TIME','SERVICE_AFFECTING','CLEAR_TIME','DURATION','ACK_TIME','ACK_USER','ALARM_TYPE','PROBABLE_CAUSE','REVERSAL'])
});
