  ...
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/util.js"></script> 
    <script type="text/javascript">
   		...
   		var shieldId = '<%=request.getParameter("shieldId")%>';
   		var alarmIds = '<%=request.getParameter("alarmIds")%>';
   		var tabFlag = '<%=request.getParameter("tabFlag")%>';
    </script>
    <script type="text/javascript">
		var FACTORY=<%=CommonDefine.toJsonArray(CommonDefine.FACTORY)%>;
	</script>
    <script type="text/javascript" src="addAlarmShield.js"></script>
  </head>
<body>
</body>
</html>