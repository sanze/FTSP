...
<head><meta http-equiv="X-UA-Compatible" content="IE=8">
 <title>FTSP3.0 传输网络维护支撑平台</title>
	...
	<script language="JavaScript" src="../../../resource/FusionCharts/JS/FusionCharts.js"></script>
	<script type="text/javascript">
		var userId=-1;
	</script>
	<script type="text/javascript" src="AvailabilityCommon.js"></script>
	<script type="text/javascript" src="portAvailability-route.js"></script>
</head> 
<body>
</body>
</html>
