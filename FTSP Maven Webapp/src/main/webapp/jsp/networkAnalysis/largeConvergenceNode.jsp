...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/js/ColumnHeaderGroup.js"></script> 
...
<script type="text/javascript">
	...
	var leafType=<%=CommonDefine.TREE.NODE.SUBNET%>;
</script>

<script type="text/javascript" src="<%=request.getContextPath()%>/jsp/networkAnalysis/commonNetwork.js"></script>  
<script type="text/javascript" src="largeConvergenceNode.js"></script> 
</head> 
<body>
</body>
