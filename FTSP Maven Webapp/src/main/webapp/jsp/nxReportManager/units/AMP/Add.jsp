...
<script type="text/javascript">
	...
	var PROMODE=<%=CommonDefine.toJsonArray(CommonDefine.UNIT_PROMODE)%>;
	var waveDirId = <%=request.getParameter("waveDirId")%>;
	var neIdPassed = <%=request.getParameter("neId")%>;
	var type = <%=request.getParameter("type")%>;
</script>
<script type="text/javascript" src="../../common/utils.js"></script>
<script type="text/javascript" src="unitWindow.js"></script>
