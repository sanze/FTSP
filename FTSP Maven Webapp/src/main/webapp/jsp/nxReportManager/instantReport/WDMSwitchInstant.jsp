...
<script type="text/javascript">
	var repType=<%=CommonDefine.QUARTZ.JOB_NX_REPORT_WDM_SWITCH%>;
	var userId=<%=session.getAttribute("SYS_USER_ID")%>;
...
<script type="text/javascript"	src="../common/SWITCHDefine.js"></script>
<script type="text/javascript" src="../common/delete.js"></script>
<script type="text/javascript" src="WDMAmplifierInstant.js"></script>
