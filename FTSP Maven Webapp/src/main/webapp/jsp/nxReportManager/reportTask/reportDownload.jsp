...
<script type="text/javascript">
	...
	var ALL_NX_TASK_TYPE = typeDefine.WAVELENGTH+','
							+typeDefine.AMP+','+typeDefine.SWITCH+','+typeDefine.WAVE_DIV+','
							+typeDefine.WAVE_JOIN+','+typeDefine.SDH_PM+','+typeDefine.PTN_IPRAN+','+typeDefine.PTN_FLOW_PEAK;
	</script>
<script type="text/javascript" src="reportDownload.js"></script>
