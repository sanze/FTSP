...
--%>
    ...
    <script type="text/javascript">
		...
		var engineerId="<%=request.getParameter("engineerId")%>";
		var leafType=<%=CommonDefine.TREE.NODE.NE%>;
		var CommonDefine=new Object();
		CommonDefine.NameSeparator="<%=CommonDefine.NameSeparator%>";
    </script>
    <script type="text/javascript" src="editPackage.js"></script>
