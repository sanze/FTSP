...
<head>
 <title>FTSP3.0 传输网络维护支撑平台</title>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resource/expandExt/css/GroupHeaderPlugin.css" />
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/js/ext-lang-zh_CN.js"></script>
 	...
 	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/ux/LockGroupHeaderPlugin.js"></script>
	...
	<script type="text/javascript">
		...
		var endDate=<%=getStringParameter(request.getParameter("endDate"))%>;
	</script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/jsp/resourceManager/common/projectCommon.js"></script>

	<script type="text/javascript" src="attenuationSearch.js"></script>
</head> 
<body>
</body>
</html>
