...
<html>
  <head>
    ...
    <script language="JavaScript" src="<%=request.getContextPath()%>/resource/FusionCharts/JS/FusionCharts.js"></script>
	...
	<script type="text/javascript" src="linkEvaluateLine.js"></script>
</head>
<body>
</body>
</html>