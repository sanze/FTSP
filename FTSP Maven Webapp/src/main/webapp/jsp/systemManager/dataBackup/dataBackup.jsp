...
<html>
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
    ...
    <script type="text/javascript" src="manualDataBackup.js"></script>
    <script type="text/javascript" src="autoDataBackup.js"></script>
    <script type="text/javascript" src="dataBackup.js"></script>
