...
<html>
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
    ...
    <script type="text/javascript">
        var	periodType="<%=request.getParameter("periodType")%>";
        var	period="<%=request.getParameter("period")%>";
        var nextSyncTime = "<%=request.getParameter("nextSyncTime")%>";
    ...
    <script type="text/javascript" src="syncCycleSetting.js"></script>
