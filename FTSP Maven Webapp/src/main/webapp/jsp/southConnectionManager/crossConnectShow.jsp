...
<title>FTSP 传输网络维护支撑平台</title>
    ...
    <script type="text/javascript">		
		...
		var neType="<%=request.getParameter("neType")%>";
		var neName="<%=request.getParameter("neName")%>";
		neName= decodeURI(neName);
    	</script>
	<script type="text/javascript" src="crossConnectShow.js"></script>	
</head>
<body>
</body>
</html>