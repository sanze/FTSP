...
Ext.Flex = Ext.extend(Ext.BoxComponent, {
        ...
        initComponent : function () {
            ...
            case "ola":
            	...
            	break;
            case "car_topo":
                this.url = Ext.Flex.CHANNEL_AVAILABILITY_URL;
                break;
            case "topo":
            default:
...
Ext.Flex.CHANNEL_AVAILABILITY_URL = preUrl + "viewManager/ChannelAvailability.swf";
//Ext.Flex.BAYFACE_URL = "Bayface.swf";
