...
<html>
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
    ...
    <script type="text/javascript" src="modifyODF.js"></script>
 
    <script type="text/javascript">  
   		var roomId = "<%=request.getParameter("roomId")%>";
		var odfId = "<%=request.getParameter("odfId")%>";  
    	var mOdfNo = "<%=request.getParameter("mOdfNo")%>";
   	  	var mCableName = "<%=request.getParameter("mCableName")%>";
   	  	var mCableId= "<%=request.getParameter("mCableId")%>";
  	  	var mFiberNo = "<%=request.getParameter("mFiberNo")%>";  
  	  	var mUseable = "<%=request.getParameter("mUseable")%>";
    	var mNote = "<%=request.getParameter("mNote")%>";
    </script> 
