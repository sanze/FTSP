...
<!--     <script type="text/javascript" src="../../../jsp/commonManager/deviceAuthCombox.js"></script> -->
    ...
    <script type="text/javascript" src="../../../resource/FusionCharts/JS/FusionCharts.js"></script>
        <script type="text/javascript" src="../../../resource/js/util.js"></script>
    <script type="text/javascript">
       userId="<%=session.getAttribute("SYS_USER_ID")%>";  
    </script>
   		
    <script type="text/javascript" src="resourceStatistic.js"></script>
  </head>
