  ...
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/util.js"></script> 
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resource/expandExt/css/fileuploadfield.css"/>
     <style type=text/css>
        .uploader {
            background: url('<%=request.getContextPath()%>/resource/images/buttonImages/add.png') no-repeat 0 0 !important;
        }
    </style>
    ...
    <script type="text/javascript" src="standardOpticalValueListForReport.js"></script>
  </head>
