...
<script type="text/javascript"
	src="../performanceReport/neTaskFieldSet.js"></script>
<script type="text/javascript" src="../performanceReport/addNe.js"></script>
<script type="text/javascript" src="../performanceReport/pmReportSearchDefine.js"></script>
<script type="text/javascript">
	repType =
<%=request.getParameter("repType")%>
	;
</script>
<script type="text/javascript" src="pmInstantGenNe.js"></script>
