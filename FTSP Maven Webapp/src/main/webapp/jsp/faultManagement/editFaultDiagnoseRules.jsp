...
<script type="text/javascript" src="conmonConvegerDefine.js"></script>
<script type="text/javascript" src="editFaultDiagnoseRules.js"></script>

<script type="text/javascript">
	var editType = <%=request.getParameter("editType")%>;	
	if(editType==1 || editType==2){ 
	//修改
		var DIAGNOSE_ID = <%=request.getParameter("DIAGNOSE_ID")%>;
	}
</script>
</head>
