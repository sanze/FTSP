...
var store= new Ext.data.Store({
	url : 'fault-diagnose!getApplyScope.action',
	baseParams : { 
		'paramMap.diagnoseId':diagnoseId_scope
	},
...
var gridPanel = new Ext.grid.GridPanel({
	...
	buttons:[{
		  ...
		  handler : function(){
			  ...
			  parent.frames["editFaultDiagnose_panel"].Ext.getCmp('scopeText').setValue(applyStr); 
//			  parent.eqStr="";
//			  parent.frames["editFaultDiagnose_panel"].Ext.getCmp('applyEquip').setValue("");   
