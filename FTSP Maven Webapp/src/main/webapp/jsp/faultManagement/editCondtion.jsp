...
<script type="text/javascript" src="editCondtion.js"></script>

<script type="text/javascript"> 
	var editType = <%=request.getParameter("editType")%>;	
	if(editType==1){
		var linenum = <%=request.getParameter("linenum")%>;	
		var alarmName = "<%=request.getParameter("alarmName")%>";	
		var objType = <%=request.getParameter("objType")%>;	
		var alarmLevelCheck = "<%=request.getParameter("alarmLevelCheck")%>";	
	}
</script>
</head>
