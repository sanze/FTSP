...
<html>
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resource/ext/src/ext-all-debug.js"></script>
    ...
    <script type="text/javascript" src="competence_detail.js"></script>
       <style type="text/css">
        .x-check-group-alt {
            background: #D1DDEF;
...
/* 　　		} */
      	  .button-red {
			background-color:red;no-repeat 1px 2px !important;
		}
        
    </style>
  </head>
<body>
<input type="button" id="show-btn"value="ShowWindow"/>
