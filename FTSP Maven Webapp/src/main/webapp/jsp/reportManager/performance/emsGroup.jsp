...
<html>
  <head><meta http-equiv="X-UA-Compatible" content="IE=8">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript" src="<%=request.getContextPath()%>/jsp/reportManager/common/commonQueryConditionNew.js"></script>
    <script type="text/javascript" src="emsGroup_new.js"></script>
    <style type="text/css">
    </style>
  </head>
<body>
