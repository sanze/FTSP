...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resource/expandExt/css/RowEditor.css" />
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/js/timeComponent/WdatePicker.js"></script> 
 <script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/ux/RowEditor.js"></script>
 
<script type="text/javascript" src="detailExercise.js"></script>

<script type="text/javascript">   
	var FAULT_EP_EXERCISE_ID = <%=request.getParameter("FAULT_EP_EXERCISE_ID")%>;	 
</script>
</head> 
<body>
</body>
