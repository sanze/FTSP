...
public interface AreaManagerMapper {
	...
	public List<Map<String, Object>> getSubNeByIDs(
			...
			@Param(value = "ifRelate") int ifRelate,
			@Param(value = "map") Map map,
			@Param(value = "start") int start,
			@Param(value = "limit") int limit);
	
	public int countSubNeByIDs(
			@Param(value = "userId")Integer userId,
			@Param(value = "Define") Map define,
			@Param(value = "ifRelate") int ifRelate,
			@Param(value = "map") Map map);
	 ...
	 * @return
	 */
	public Map<String,Object> getAreaInfo(@Param(value = "nodeId") int nodeId);
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getRelatedNE(@Param(value = "stationId") int stationId,
	...
	public List<Map<String, Object>> getCable(
			@Param(value = "stationId") int stationId); 
	// 获取机房下属ddf
	public List<Map<String, Object>> getDdfs(@Param(value = "roomId") int roomId); 
	// 获取机房下属odf
	public List<Map<String, Object>> getOdfs(@Param(value = "roomId") int roomId); 
	/**
	 * mod room校验
	 * @param map
	 * @return
	...
	public void neRelateTo(@Param(value = "nodeId") int nodeId,
			@Param(value = "prtId") int prtId,
			@Param(value = "level") int level,
			@Param(value = "ids") String ids); 
	
	public void cancelRelateTo(@Param(value = "ids") String ids); 
	
	public List<Map<String, Object>> getRelatedEquip(@Param(value = "roomId") int roomId); 
	 ...
	 * 获取首个顶级区域名称和ID
	 */
	public Map<String,Object> getTopAreaNameAndId();
}
