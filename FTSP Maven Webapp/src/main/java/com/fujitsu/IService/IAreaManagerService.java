...
public interface IAreaManagerService {
	...
	public Map<String, Object> getRoomGrid(int parentId, int parentLevel, boolean showAll,String name,int start,int limit)throws CommonException;
	//获取区域的 子局站 Grid列表
	 ...
	 * @@@分权分域到网元@@@
	 */
	public Map<String, Object> getNeGrid(Integer userId,Map<String,Object> param, int ifRelate,int start,int limit)throws CommonException;
