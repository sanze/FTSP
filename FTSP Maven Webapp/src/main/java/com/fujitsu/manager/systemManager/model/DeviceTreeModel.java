...
public class DeviceTreeModel implements Serializable{
	...
	private List<DeviceTreeModel> children;
	...
	public List<DeviceTreeModel> getChildren() {
		return children;
	}
	public void setChildren(List<DeviceTreeModel> children) {
