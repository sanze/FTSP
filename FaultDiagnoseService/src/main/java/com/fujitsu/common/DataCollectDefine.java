...
//	public final static int NMS_TYPE_VEMS_FLAG = 99;
	...
	public static class ALU {
		...
		public final static String PTP_SHELF = "s";
		public final static String PTP_SLOT = "b";
		public final static String PTP_PORT = "p";
		
		public final static String PTP_REGEX = "/r[0-9]+s[0-9]+b[0-9]+p[0-9]+";
