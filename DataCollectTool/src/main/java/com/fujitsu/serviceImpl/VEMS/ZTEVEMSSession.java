...
import ZTE_U31.ethernet.EthernetSNCList_THelper;
...
import ZTE_U31.protection.SwitchData_T;
...
import ZTE_U31.subnetworkConnection.SubnetworkConnection_THelper;
...
public class ZTEVEMSSession extends VEMSSession implements IZTEEMSSession,EmsSession_I{
	...
	static{
		...
		CmdObjectHelper.put(getAllEthernetSubnetworkConnections,EthernetSNCList_THelper.class);
